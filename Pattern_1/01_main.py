...
class Algo1(MainAlgo):
    def execute(self):
        for symbol in self.data:
            self.result += str(ord(symbol) % 2)


class Algo2(MainAlgo):
    def execute(self):
        i = 0
        for _ in self.data:
            self.result += str(i)
...
class Algo3(MainAlgo):
    def execute(self):
        self.result = str(len(self.data))


class AlgoIn(MainAlgo):
    def execute(self):
